...
class Media {
  ...
  createShader() {
    ...
    // Use process.env.PUBLIC_URL to resolve image paths correctly
    img.src = process.env.PUBLIC_URL + this.image;
    img.onload = () => {
      texture.image = img;
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: '/images/landing_img1.jpg', text: 'Luxury Villa' },
      { image: '/images/landing_img2.jpg', text: 'Modern Condo' },
      { image: '/images/landing_img3.jpg', text: 'Cozy Cottage' },
      { image: '/images/landing_img4.jpg', text: 'Beachfront Estate' },
      { image: '/images/landing_img5.jpg', text: 'Urban Loft' },
      { image: '/images/landing_img6.jpg', text: 'Mountain Retreat' },
      { image: '/images/landing_img7.jpg', text: 'City Penthouse' },
      { image: '/images/landing_img8.jpg', text: 'Rustic Farmhouse' },
      { image: '/images/landing_img9.jpg', text: 'Lake House' },
      { image: '/images/landing_img10.jpg', text: 'Skyline Apartment' },
    ];
...
function CircularGallery({ items, bend = 3, textColor = '#ffffff', borderRadius = 0, font = 'bold 30px Figtree' }) {
...
function GallerySection() {
  ...
  return (
    <section id="gallery" className="py-16 pt-4 px-4 bg-[#fdfdfd]">
      ...
      >
        <motion.h2
          className="text-4xl font-bold text-gray-800 mb-6 mt-10"
